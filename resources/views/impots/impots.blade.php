...
<div class="section firstSec active" id="firstSec">
  ...
  <a href="{{ route('login_impots')}}" style="float: right;border: none;background-color: transparent;cursor: pointer;color: #fff;padding: 14px 32px;font-weight: 600;font-size: 18px;border-radius: 30px;background: #3A86FF;">
    Se connecter</a>
