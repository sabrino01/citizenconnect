...
<div class="section firstSec active" id="firstSec">
  ...
  @foreach($add as $adds)
  <a style="float: right;border: none;background-color: transparent;cursor: pointer;color: #fff;padding: 14px 32px;font-weight: 600;font-size: 18px;border-radius: 30px;background: #3A86FF;" class="nav-link dropdown-toggle" href="{{ route('impots.index')}}">
...
<!--start footer-->
<footer class='footer'>Services Impôts</footer>
